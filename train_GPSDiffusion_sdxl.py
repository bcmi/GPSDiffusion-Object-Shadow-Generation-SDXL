...
class TrainDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        shadow_img = self.load_image('shadow_imgs', pic_name)
...
def parse_args(input_args=None):
    ...
    parser.add_argument("--pretrained_ip_adapter_path", default=None, type=str)
    parser.add_argument(
...
def main(args):
    ...
    if args.controlnet_model_name_or_path:
        ...
        controlnet = ControlNetModel.from_pretrained(args.controlnet_model_name_or_path, device_map="cpu")
    else:
    ...
    params_to_optimize += ip_adapter.image_proj_model.parameters()
    params_to_optimize += ip_adapter.adapter_modules.parameters()
    ...
    def custom_collate_fn(batch):
        ...
        device = accelerator.device  # 确保accelerator已初始化
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(controlnet):
                ...
                fg_instance_bbx = fg_instance_bbx.to(accelerator.device)
                ...
                if accelerator.sync_gradients:
                    ...
                    list(ip_adapter.image_proj_model.parameters()) + \
        ...
        if accelerator.is_main_process:
            ...
            }, os.path.join(save_dir, "ip_adapter.ckpt"))
